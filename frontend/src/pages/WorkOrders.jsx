...
import {
  ...
  Image, Timeline, message, Popover, Badge, Typography, Divider, Row, Col, Card
} from 'antd'
import {
  UserOutlined, ReloadOutlined, ToolOutlined, CheckCircleOutlined,
  CheckSquareOutlined, EyeOutlined, ClockCircleOutlined
...
export default function WorkOrders() {
  ...
  const handleAssign = async () => {
    ...
    try {
      await api.put(`/work-orders/${currentOrder.id}/assign`, { assignee_name: assigneeName.trim() })
  ...
  const columns = [
    ...
    { title: '设备', dataIndex: 'device_name', width: 140, render: (_, r) => <Tag>{r.device_name} ({r.device_code})</Tag> },
    { title: '所属产线', dataIndex: 'line_name', width: 100 },
    { title: '异常项', dataIndex: 'item_name', width: 120 },
    {
      title: '状态',
      dataIndex: 'status',
      width: 100,
          ...
          <div>
            <Descriptions column={2} bordered size="small" style={{ marginBottom: 16 }}>
              ...
              <Descriptions.Item label="状态">
                <Tag icon={statusConfig[currentOrder.status].icon} color={statusConfig[currentOrder.status].color}>
